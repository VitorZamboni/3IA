...
select emp_no, last_name, job_code, hire_date, phone_ext from employee;
...
select last_name, dept_no, emp_no from employee where emp_no = 85;
...
select last_name, salary from employee where salary > 40000 and salary < 70000 order by salary;

/*  Exiba um relatorio para exibir o sobrenome, o ID do cargo e a data de admissão dos funcionários cujos sobrenomes sejam Johnson e Young.*/
...
select last_name, salary, dept_no from employee where salary between 40000 and 70000 and dept_no in(120, 623) order by salary desc;
